<%@ Page Title="" Language="C#" MasterPageFile="~/Data_Cohort1/MasterPage/SiteInstruction.master" AutoEventWireup="true" CodeFile="Instructions.aspx.cs" Inherits="PGM_Information_Instructions" %>
                    ...
                    <ul type="disc">
                        ...
                        <li>As part of the assessment, you will go through following exercises:
                          <ul type="circle">
                              ...
                              <li><span class="font-weight-bold">CFT Panel Interview : </span>You will be required to prepare a 4-5 slide presentation on the allocated case scenario within 30 minutes. You will then present it to a panel, with the presentation limited to 20 minutes, followed by a 10-minute Q&A session with the CFT Panel.
                              </li>
                             </ul>
