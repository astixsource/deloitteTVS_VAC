<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort1/MasterPage/Panel.master" AutoEventWireup="false" CodeFile="ExerciseMain.aspx.vb" Inherits="Set1_Main_frmExerciseMain_New" %>
        ...
        function fnOpenTest(RspID, ExerciseID, TotalTime, ExerciseType, LoginID) {
            ...
            if (ExerciseID == 1) {
               // window.location.href = "../CaseStudy/frmCaseStudy_Business1.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
                ...
                window.location.href = "../CaseStudy/CaseStudy_CFT_Panel.aspx?MenuId=6" + "&RspID=" + RspID + "&ExerciseID=" + ExerciseID + "&ExerciseType=" + ExerciseType + "&TotalTime=" + TotalTime + "&intLoginID=" + LoginID
            }
