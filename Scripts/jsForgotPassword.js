...
jQuery(function ($) {
    ...
    function fnChangePassword() {
        ...
        if ($("#hdnOldValue").val() === NewPassword) {
        ...
        $.ajax({
            url: "eywebservice.asmx/fnResetPassword",
            type: "POST",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            data: '{UserId:' + JSON.stringify($("#hdnUserId").val()) + ',NewPassword:' + JSON.stringify(NewPassword) + '}',
            success: function (response) {
                ...
                if (strRep.split("^")[0] == "2") {
                    ...
                    if (str.split("-")[0] == "1" && str.split("-")[1] == "0") {
                        alert("Password Reset Successfully,You can login again!!");
                        //fnlater();
                        $("#txtOldPassword").val("");
                        $("#txtNewPassword").val("");
                        $("#txtConfirmPassword").val("");
                        ...
                        alert("Invalid details. Please contact support!!");
                    }
                }
            },
            error: function (msg) {
