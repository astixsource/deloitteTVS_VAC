...
document.addEventListener("keydown", function (event) {
    if (event.key === "F5" || (event.ctrlKey && event.key === "r")) {
        ...
        alert("Refreshing is disabled during the assessment!");
...
//        console.log("Alt+Tab is blocked!");
//    }
//});
...
//    e.preventDefault();
//    e.returnValue = '';
//    alert("Opening new tabs is not allowed during the assessment.");
//    return false;
//};

//window.onblur = function () {
//    alert("Please stay on the assessment page. Opening new tabs is not allowed.");
//    window.focus();
//};
