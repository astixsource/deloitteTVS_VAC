...
Partial Class Set1_CaseStudy_CaseStudyInstructions
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        TimeAlloted = 0 ' IIf(IsNothing(Request.QueryString("TotalTime")), 0, Request.QueryString("TotalTime"))
    ...
    Protected Sub btnBack_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("CaseStudyInstructions1.aspx?ExerciseID=" & ExcersiseID & "&RspID=" & RspID & "&BandID=" & BandID & "&intLoginID=" & intLoginID)
    End Sub
End Class
