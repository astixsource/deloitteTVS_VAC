<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort3/MasterPage/Site.master" AutoEventWireup="false" CodeFile="CaseStudy_Technical3.aspx.vb" Inherits="CaseStudy" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function fnCaseExercise() {
            window.location.href = "CaseStudyInstructions_Technical3.aspx?RspID=" + $("#ConatntMatter_hdnRspID").val() + "&ExerciseID=" + $("#ConatntMatter_hdnExerciseID").val() + "&intLoginID=" + $("#ConatntMatter_hdnLoginID").val();
            //$("#divCaseStudy").dialog({
            //    title: 'Case Study ',
            //    modal: true,
            //    width: '80%',
