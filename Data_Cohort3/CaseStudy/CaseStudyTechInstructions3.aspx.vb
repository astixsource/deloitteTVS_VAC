...
Partial Class CaseStudyTechInstructions3
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("CaseStudyInstructions_Technical3.aspx?ExerciseID=" & ExcersiseID & "&RspID=" & RspID & "&BandID=" & BandID & "&intLoginID=" & intLoginID)
    End Sub
End Class
