...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
           <p>This exercise aims to assess participant’s ability to prioritize tasks and manage time effectively while 
responding to multiple requests and situations in a professional environment. </p>

            <h4>Scenario Context: </h4>
            <p>You are the Service Manager at Velocity Motors, a leading two-wheeler dealership. Your responsibilities 
include ensuring exceptional after-sales service, meeting revenue targets, developing the service team, 
and implementing innovative solutions. You are just back from a 2-day leave. During your absence, you 
received some critical emails that require your immediate attention.</p>

             <h4>Instructions: </h4>
            <ul>
                <li>You have received five urgent emails that require immediate action. Based on their urgency and 
impact on TVSM’s operations and customer care, prioritize the emails basis their importance/urgency 
and rank them from Low to High</li>
