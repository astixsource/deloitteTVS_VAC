<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort3/MasterPage/Site.master" AutoEventWireup="false" CodeFile="SJTTest_1.aspx.vb" Inherits="SJT_SJTTest" %>
        ...
        function fnNext() {
            ...
            if (flgExerciseStatus != 2) {
                ...
                if (document.getElementById("ConatntMatter_hdnPageNmbr").value == TotalQuestions) {
                    Status = 2
                    //alert(strRet)
                    if (window.confirm("Are you sure you have completed this exercise ?\nClick OK if you have completed. Please note you will not be able to resume once you click OK.\nClick Cancel if you have NOT completed and need to go back to complete.")) {
