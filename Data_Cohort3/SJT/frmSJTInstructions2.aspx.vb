...
Partial Class SJT_frmSJTInstructions
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As EventArgs) Handles btnSubmit.Click
        ...
        Response.Redirect("SJTTest_2.aspx?ExerciseID=" & ExcersiseID & "&ElapsedTimeMin=" & ElapsedTimeMin & "&ElapsedTimeSec=" & ElapsedTimeSec & "&TotalTime=" & TimeAlloted & "&RspID=" & RspID & "&BandID=" & BandID & "&ExerciseType=3" & "&intLoginID=" & intLoginID)
