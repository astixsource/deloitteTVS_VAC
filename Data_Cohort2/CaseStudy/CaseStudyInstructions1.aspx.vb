...
Partial Class CaseStudyInstructions1
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("CaseStudyInstructions_Business1.aspx?ExerciseID=" & ExcersiseID & "&RspID=" & RspID & "&BandID=" & BandID & "&intLoginID=" & intLoginID)
    End Sub
End Class
