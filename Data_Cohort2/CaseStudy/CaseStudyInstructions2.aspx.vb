...
Partial Class CaseStudyInstructions2
    ...
    Protected Sub btnNext_Click(sender As Object, e As EventArgs)
        ...
        Response.Redirect("CaseStudyInstructions_Business2.aspx?ExerciseID=" & ExcersiseID & "&RspID=" & RspID & "&BandID=" & BandID & "&intLoginID=" & intLoginID)
    End Sub
End Class
