<%@ Page Title="" Language="VB" MasterPageFile="~/Data_Cohort2/MasterPage/SiteInstruction.master" AutoEventWireup="false" CodeFile="frmBasket_InstructionsMain.aspx.vb" Inherits="Set1_Basket_frmBasket_InstructionsMain" %>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
           <p>This exercise aims to assess participant&rsquo;s ability to prioritize tasks and manage time effectively while responding to multiple requests and situations in a professional environment.</p>
            <p><strong>Scenario Context:<br />
                <br />
            </strong></p>
            <p>You are the Area Manager for the East region. Your responsibilities include ensuring exceptional after-sales service, meeting revenue targets, developing the service team, and implementing innovative solutions. Below are emails requiring your immediate attention.</p>
