<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMaster/AdminMaster.master" AutoEventWireup="true" CodeFile="frmPartDeveloperStatus.aspx.cs" Inherits="Mapping" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ConatntMatter" runat="Server">
    <div class="section-title clearfix">
        <h3 class="text-center">Participant DC Status</h3>
   ...
   <div class="form-group row">
    ...
    <div id="dvBtns" style="padding-top: 10px;">
        <table>
            <tr>
                <td><b>Legends : </b></td>
                <td style="background-color:#fffacc;padding:3px 5px">
                    In Progress
                </td>
                 <td style="background-color:#b1b1b1;padding:3px 5px">
                     Exercise To Be Started
                </td>
                 <td style="background-color:#fecddf;padding:3px 5px">
                     Delayed
                </td>
                 <td style="background-color:#ceffde;padding:3px 5px">
                     Completed
                </td>
            </tr>
